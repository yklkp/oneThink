...
<head>
    ...
    <script type="text/javascript" src="/onethink/www/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/onethink/www", //当前网站地址
            "APP"    : "/onethink/www/index.php?s=", //当前项目地址
            "PUBLIC" : "/onethink/www/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/onethink/www/Public/static/think.js"></script>
    <script type="text/javascript" src="/onethink/www/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/onethink/www/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/onethink/www/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/onethink/www/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/onethink/www/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/onethink/www/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
